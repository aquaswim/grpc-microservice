...
const file_user_v1_auth_proto_rawDesc = "" +
	...
	"\x0fUpdateMyProfile\x12\x1f.user.v1.UpdateMyProfileRequest\x1a .user.v1.UpdateMyProfileResponse\"\x04\x88\xb5\x18\x01B\x88\x01\n" +
	"\vcom.user.v1B\tAuthProtoP\x01Z1gaman-microservice/api-gateway/gen/user/v1;userv1\xa2\x02\x03UXX\xaa\x02\aUser.V1\xca\x02\aUser\\V1\xe2\x02\x13User\\V1\\GPBMetadata\xea\x02\bUser::V1b\x06proto3"
